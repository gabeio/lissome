...
scripts:
	...
	test: 'gulp build && gulp build-tests && mocha test/*.js'
	test-ci: 'istanbul cover gulp test --report lcovonly -- -R spec && cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js && rm -rf ./coverage'
