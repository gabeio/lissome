...
describe "Assignments" ->
	...
	describe "Student", (...)->
		it.skip "should not allow a student to create an assignment", (done)->
		it.skip "should not allow a student to edit an assignment", (done)->
		it.skip "should not allow a student to delete an assignment", (done)->
		it.skip "should allow a student to view a list of assignments", (done)->
		it.skip "should allow a student to view an assignment", (done)->
	describe "Outside Student", (...)->
		it.skip "should not allow an outside student to create an assignment", (done)->
		it.skip "should not allow an outside student to edit an assignment", (done)->
		it.skip "should not allow an outside student to delete an assignment", (done)->
		it.skip "should not allow an outside student to view a list of assignments", (done)->
		it.skip "should now allow an outside student to view an assignment", (done)->
